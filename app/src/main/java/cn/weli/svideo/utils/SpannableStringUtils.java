...
public class SpannableStringUtils {
    ...
    public static class Builder {
        ...
        private void setSpan() {
            ...
            if (imageIsBitmap || imageIsDrawable || imageIsUri || imageIsResourceId) {
                if (imageIsBitmap) {
                    mBuilder.setSpan(new CustomImageSpan(WlVideoAppInfo.sAppCtx, bitmap, align), start, end, flag);
                    bitmap = null;
                    imageIsBitmap = false;
                    ...
                    mBuilder.setSpan(new CustomImageSpan(WlVideoAppInfo.sAppCtx, uri, align), start, end, flag);
                    uri = null;
                    imageIsUri = false;
                } else {
                    mBuilder.setSpan(new CustomImageSpan(WlVideoAppInfo.sAppCtx, resourceId, align), start, end, flag);
                    resourceId = 0;
    ...
    static abstract class CustomDynamicDrawableSpan extends ReplacementSpan {
        ...
        public void draw(@NonNull Canvas canvas, CharSequence text,
            ...
            int transY = (int) (y + paint.getFontMetrics().descent - rect.bottom);//算上行高
