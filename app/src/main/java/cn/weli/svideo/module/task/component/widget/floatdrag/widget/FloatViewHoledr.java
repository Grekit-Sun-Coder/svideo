...
import cn.weli.svideo.module.task.component.widget.floatdrag.anchor.CollapsedMenuAnchor;
import cn.weli.svideo.module.task.component.widget.floatdrag.anchor.Dragger;
import cn.weli.svideo.module.task.component.widget.floatdrag.anchor.MagnetPositioner;
import cn.weli.svideo.module.task.component.widget.floatdrag.anchor.Navigator;
import cn.weli.svideo.module.task.component.widget.floatdrag.anchor.Positionable;
import cn.weli.svideo.module.task.component.widget.floatdrag.view.FloatView;
import cn.weli.svideo.module.task.component.widget.floatdrag.view.HoverMenuExitRequestListener;
...
public class FloatViewHoledr extends RelativeLayout implements HoverMenuExitRequestListener {
    ...
    private OnFloatViewClickListener mViewClickListener;
    ...
    private CollapsedMenuViewController mCollapsedMenuViewController = new CollapsedMenuViewController() {
        ...
        public void onSingleTap() {
            if (mViewClickListener != null) {
                mViewClickListener.onFloatViewClick();
            }
        }
    };
    ...
    private Dragger.DragListener mDragListener = new Dragger.DragListener() {
        ...
        public void onTap() {
            ...
            getCollapsedMenuViewController().onRelease();
            getCollapsedMenuViewController().onSingleTap();
        }
    };
    ...
    public void setViewClickListener(OnFloatViewClickListener viewClickListener) {
    ...
    private void init() {
        ...
        mFloatViewSize = getResources().getDimensionPixelSize(R.dimen.common_len_150px);
    ...
    private ObjectAnimator createExitObjectAnimator() {
        PropertyValuesHolder scaleX = PropertyValuesHolder.ofFloat(View.SCALE_X, 1.0f, 0.1f);
        PropertyValuesHolder scaleY = PropertyValuesHolder.ofFloat(View.SCALE_Y, 1.0f, 0.1f);
