...
import cn.weli.svideo.module.mine.presenter.CoinDetailPresenter;
import cn.weli.svideo.module.mine.view.ICoinDetailView;
 ...
 * @version [1.0.0]
 * @date 2019-11-20
 * @see MineProfitActivity
 * @since [1.0.0]
 */
public class CoinDetailFragment extends AppBaseFragment<CoinDetailPresenter, ICoinDetailView> implements
        ICoinDetailView, OnRefreshListener, OnLoadMoreListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        if (mFragmentView == null) {
            mFragmentView = inflater.inflate(R.layout.fragment_coin_detail, container, false);
    ...
    @Override
    protected Class<CoinDetailPresenter> getPresenterClass() {
        return CoinDetailPresenter.class;
    }

    @Override
    protected Class<ICoinDetailView> getViewClass() {
        return ICoinDetailView.class;
    }
}
