 ...
 * @since [1.0.0]
 */
public class CoinDetailPresenter implements IPresenter {
     ...
     * 流水类型
     */
    private static final String FLAG_TYPE = "GOLD";

    private ICoinDetailView mView;
    ...
    public CoinDetailPresenter(ICoinDetailView view) {
        mView = view;
