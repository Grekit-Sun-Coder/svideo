...
public class CollapsedMenuAnchor {
    ...
    private int mAnchorSideOffset; // How far beyond the left/right bounds should the anchor sit.
    ...
    public CollapsedMenuAnchor(@NonNull DisplayMetrics displayMetrics, int anchorSideOffsetInDp) {
       setAnchorSideOffset(displayMetrics,anchorSideOffsetInDp);
    }

    public void setAnchorSideOffset(DisplayMetrics displayMetrics, int anchorSideOffsetInDp){
