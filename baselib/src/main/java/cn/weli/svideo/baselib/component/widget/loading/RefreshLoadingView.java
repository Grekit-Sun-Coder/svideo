 ...
 * @version [1.0.0]
 * @date 2019-11-21
 * @see cn.weli.svideo.baselib.component.widget.smartrefresh.WeRefreshHeader
 * @since [1.0.0]
 */
public class RefreshLoadingView extends View {
    ...
    public RefreshLoadingView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs, defStyleAttr, R.style.LoadingIndicatorView);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public RefreshLoadingView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        setIndicator(new RefreshIndicator());
        a.recycle();
    }
    ...
    public void setIndicator(String indicatorName) {
        ...
        try {
            ...
            Logger.e("Didn't find your class , check the name again !");
