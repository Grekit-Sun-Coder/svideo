...
public class TimeUtil {
    ...
    public final static String TIME_FORMAT_HOUR_MINUTE = "HH:mm";
    public final static String TIME_FORMAT_DAY = "yyyy-MM-dd";
    public final static String TIME_FORMAT_DAY_POINT = "yyyy.MM.dd";
    public final static String TIME_FORMAT_WITHOUT_YEAR = "MM-dd HH:mm";
    public final static String TIME_FORMAT_HOUR = "HH:mm:ss";

    public final static long TIME_ONE_MINUTE = 60 * 1000;
    public final static long TIME_SIXTY_MINUTE = 60 * 60 * 1000;
    public final static long TIME_TWENTY_FOUR_HOUR = 24 * 60 * 60 * 1000;
    public final static long TIME_FORTY_EIGHT_HOUR = 48 * 60 * 60 * 1000;
     ...
     * 获取当前时间
     *
     * @param format 时间格式 {@link TimeUtil}
     */
     ...
     * @param milliseconds 毫秒时间戳
     * @param unit         <ul>
     *                     <li>{@link ConstUtil#MSEC}: 毫秒</li>
     *                     <li>{@link ConstUtil#SEC }: 秒</li>
     *                     <li>{@link ConstUtil#MIN }: 分</li>
     *                     <li>{@link ConstUtil#HOUR}: 小时</li>
     *                     <li>{@link ConstUtil#DAY }: 天</li>
     *                     </ul>
     * @return unit时间戳
     */
    ...
    public static String changeToTimeDes(long milliseconds) {
        long currentMilliseconds = System.currentTimeMillis();
        long diff = currentMilliseconds - milliseconds;

        if (diff < TIME_ONE_MINUTE) {
            return "刚刚";
        } else if (diff < TIME_SIXTY_MINUTE) {
            return diff / 1000 / 60 + "分钟前";
        } else if (diff < TIME_TWENTY_FOUR_HOUR) {
            return diff / 1000 / 60 / 60 + "小时前";
        } else if (diff < TIME_FORTY_EIGHT_HOUR) {
            return "1天前";
        } else {
            return milliseconds2String(milliseconds,
                    new SimpleDateFormat(TIME_FORMAT_MINUTE, Locale.getDefault()));
        }
    }
