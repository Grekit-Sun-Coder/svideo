package cn.weli.svideo.baselib.helper.glide.transform;
...
public class GlideCornersTransform implements Transformation<Bitmap> {
    ...
    public GlideCornersTransform(Context context, int radius, CornerType type) {
    ...
    private void drawRightBottomCorner(Canvas canvas, Paint paint, float width, float height) {
        ...
        canvas.drawArc(new RectF(width - mDiameter, height - mDiameter, width, height), 0, 90,
                true, paint);
    }
